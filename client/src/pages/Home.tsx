      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ marginTop: "64px", borderTop: `2px solid ${BORDER}`, paddingTop: "56px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "28px", maxWidth: "800px", margin: "0 auto" }}>
            {[
              { name: t.specialists.s1name[lang], role: t.specialists.s1role[lang], exp: lang === "de" ? "12 Jahre Erfahrung" : "12 years of experience", edu: lang === "de" ? "Höhere Bildung, Praktische Psychologie" : "Higher Education, Practical Psychology", photo: "/manus-storage/dimitri_large_65e18c5f.jpg" },
              { name: t.specialists.s2name[lang], role: t.specialists.s2role[lang], exp: "", edu: lang === "de" ? "Höhere Bildung, Diplompsychologin" : "Higher Education, Graduate Psychologist", photo: "/manus-storage/tatjana_cropped_8715085d.jpg" },
            ].map(s => (
